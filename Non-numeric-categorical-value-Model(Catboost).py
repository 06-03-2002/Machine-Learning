# -*- coding: utf-8 -*-
"""
Created on Thu Aug 28 01:05:40 2025
...
# --- Define save folder ---
output_folder = r"E:\URP\transportation\Airline Occurences.csv\outputs-catboost"
...
y_pred = y_pred.astype(int).flatten()  # CatBoost returns array of shape (n,1)
print(classification_report(y_test, y_pred, target_names=le.classes_))

# --- Save model, vectorizer, and label encoder ---
model.save_model(os.path.join(output_folder, "precaution_model_catboost.cbm"))
...
model = CatBoostClassifier()
model.load_model(os.path.join(output_folder, "precaution_model_catboost.cbm"))
...
y_new_pred = y_new_pred.astype(int).flatten()
predicted_labels = le.inverse_transform(y_new_pred)

# --- Save predictions ---
new_df['Predicted Occurence Precautionary Procedures'] = predicted_labels
output_csv_path = os.path.join(output_folder, "predicted_output_catboost.csv")
new_df.to_csv(output_csv_path, index=False)

print(f"✅ CatBoost model, label encoder, and CSV saved in: {output_folder}")
