# -*- coding: utf-8 -*-
"""
Created on Fri Sep 26 08:24:59 2025
...
# Clip to avoid log of zero/negative
X_clipped = np.clip(X, epsilon, None)
X_transformed = -np.log(X_clipped)

feature_names_sym = [f"-ln({col})" for col in feature_names]

# === Polynomial expansion (degree=2 or 3 for non-linear interactions) ===
...
print("\n🔑 Symbolic Logistic Regression Equation (with -ln features):")
print(logit_eq)  # preview first 2000 characters
